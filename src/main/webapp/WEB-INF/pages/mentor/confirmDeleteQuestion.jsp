...
<html>
    <head>
        ...
        <title>Confirm Delete Question</title>
    </head>
    <body>
        ...
        <table style="margin: auto; border-collapse: collapse; border: 1px black solid; width: 500px;">
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: right">
                    <button onclick="location.href = '<c:url value="/mentor/listQuestions"/>'"
                            class="btn btn-info" style="width: 100px; font-weight: bold">
                        Cancel
                    </button>
                    &nbsp;&nbsp;
                    <button onclick="location.href = '<c:url value="/mentor/deleteQuestion/${questionId}"/>'"
                            class="btn btn-info" style="width: 100px; font-weight: bold">
                        OK
                    </button>
                </td>
